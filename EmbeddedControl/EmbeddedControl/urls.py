...
urlpatterns = patterns('',
                       ...
                       url(r'^fileupload/$', 'main.views.fileupload', name='fileupload'),
                       url(r'^info/wifi/$', 'main.views.Get_Wifi_Networks', name='wifinetworks'),
                       ...
                       url(r'^info/getnetstat/$', 'usage.views.getnetstat', name='getnetstat'))+ static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)

...
dashboard.getWifi = function () {
    $.getJSON('/info/wifi/', function (data) {
        destroy_dataTable("get_wifi");
        var $filterPs = $("#filter-ps");
        $filterPs.val("").off("keyup");
        var psTable = $("#get_wifi").dataTable({
            aaData: data,
            aoColumns: [
                { sTitle: "SSID" },
                { sTitle: "Signal" },
...
dashboard.getFiles = function () {
    $.getJSON('/fileupload/', function (data) {
        destroy_dataTable("get_files");
        var $filterPs = $("#filter-ps");
        $filterPs.val("").off("keyup");
        var psTable = $("#get_files").dataTable({
            aaData: data,
            aoColumns: [
                { sTitle: "File Name" },
                { sTitle: "URL" },
